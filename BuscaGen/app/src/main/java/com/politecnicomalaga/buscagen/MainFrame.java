...
public class MainFrame extends JFrame implements ActionListener {
    ...
    protected JPanel panelEntrada;
    protected JPanel panelEntradaIzq;
    protected JPanel panelEntradaDer;    
    protected JPanel panelSelectorFichero;
    protected JPanel panelContenidoFichero;
    ...
    protected JLabel lGen;
    protected JLabel lMutaciones;
    protected JTextField tfGen;
    protected JLabel lDataMutaciones;
    protected JButton botonMasMutas;
    protected JButton botonMenosMutas;

    //Selección de fichero FASTA
    protected JButton botonSelector;    
    protected JLabel lFileSelected;
    protected JTextArea taHeadFASTA;

    //Para la botonera
    protected JButton botonEmpezar;
	...
	//Recogemos referencia al controlador
	    ...
	    //3. Ahora añadimos los paneles en la frame (ventana).		
    ...
    public void incrementaMutaciones() {
    	this.lEstado.setText("Nuevos datos introducidos");
	this.lDataMutaciones.setText(String.valueOf(Integer.valueOf(this.lDataMutaciones.getText())+1));
    }
	
    public void decrementaMutaciones() {
        this.lEstado.setText("Nuevos datos introducidos");
        if (Integer.valueOf(this.lDataMutaciones.getText())!=0)
           this.lDataMutaciones.setText(String.valueOf(Integer.valueOf(this.lDataMutaciones.getText())-1));
    ...
    public void abrirFichero() {
        ...
        if(returnVal == JFileChooser.APPROVE_OPTION) {
            //ficheroSeleccionado = chooser.getCurrentDirectory().getAbsolutePath();
